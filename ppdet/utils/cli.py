...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        default_config = os.path.join(project_root, "configs", "rtdetr", "radar_rtdetr_r50vd_6x.yml")

        self.add_argument("-c", "--config", default=default_config, help="configuration file to use")
        self.add_argument(
