...
__all__ = ['Multi_DETR_V4']
# My multispectral DETR


@register
class Multi_DETR_V4(BaseArch):
    ...
    def __init__(self,
        ...
        super(Multi_DETR_V4, self).__init__()
    ...
    def _forward(self):
        ...
        vis_body_feats3 = vis_body_feats[2]
        ir_body_feats3 = ir_body_feats[2]
        fusion_body_feats3 = vis_body_feats3 + ir_body_feats3
        vis_body_feats[2] = fusion_body_feats3
        ir_body_feats[2] = fusion_body_feats3

        del vis_body_feats3,ir_body_feats3,fusion_body_feats3
