...
__all__ = ['Multi_DETR_V7_9L']
# My multispectral DETR
#base on V3 , use 9level (3vis 3ir 3vis+ir) select query, memory also 6level(3vis + 3ir)

@register
class Multi_DETR_V7_9L(BaseArch):
    ...
    def __init__(self,
        ...
        super(Multi_DETR_V7_9L, self).__init__()
