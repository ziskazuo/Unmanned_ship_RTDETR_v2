...
__all__ = ['Multi_DETR_MISSING','Complementary_Generator']
...
@register
class Complementary_Generator(nn.Layer):
    def __init__(self,
                 ch_in1,
                 ch_in2,
                 ch_in3):
        super(Complementary_Generator, self).__init__()
...
@register
class Multi_DETR_MISSING(BaseArch):
    ...
    def __init__(self,
        ...
        super(Multi_DETR_MISSING, self).__init__()
    ...
    def _forward(self):
        ...
        if self.neck_vis is not None:
            ...
            vis_body_feats_g = self.neck_vis(vis_body_feats_g)
            ir_body_feats_g = self.neck_vis(ir_body_feats_g)
        ...
        if self.training:
            ...
            preds = (preds[0][:,300:600,:],preds[1][:,300:600,:],preds[2])
