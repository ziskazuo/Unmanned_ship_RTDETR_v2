...
__all__ = ['Multi_DETR_V2','Multi_DETR_V2_4level']
# My multispectral DETR


@register
class Multi_DETR_V2_4level(BaseArch):
    ...
    def __init__(self,
        ...
        super(Multi_DETR_V2_4level, self).__init__()
    ...
    def _forward(self):
        ...
        del vis_body_feats, ir_body_feats
        # Transformer
...
class Multi_DETR_V2(BaseArch):
    ...
    def __init__(self,
                 ...
                 with_mask=False,
                 exclude_post_process=False):
        super(Multi_DETR_V2, self).__init__()
        self.backbone_vis = backbone_vis
        self.backbone_ir = backbone_ir
        self.transformer = transformer
        self.detr_head = detr_head
