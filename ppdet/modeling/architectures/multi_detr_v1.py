...
__all__ = ['Multi_DETR_V1']
# My multispectral DETR


@register
class Multi_DETR_V1(BaseArch):
    ...
    def __init__(self,
        ...
        super(Multi_DETR_V1, self).__init__()
    ...
    def _forward(self):
        ...
        if self.neck is not None:
            ...
            vis_body_feats = self.neck(vis_body_feats)
            ir_body_feats = self.neck(ir_body_feats)
