...
class MSDeformableAttention_RadarCamera(nn.Layer):
    def __init__(self,
                 embed_dim=256,
                 num_heads=8,
                 num_levels=4,
        ...
        Multi-Scale Deformable Attention Module
        """
        super(MSDeformableAttention_RadarCamera, self).__init__()
        self.embed_dim = embed_dim
        self.num_heads = num_heads
        self.num_levels = num_levels
        self.num_points = num_points
        ...
        try:
            ...
            # use paddle func
            from .utils import radarcamera_deformable_attention_core_func as ms_deformable_attn
        self.ms_deformable_attn_core = ms_deformable_attn
