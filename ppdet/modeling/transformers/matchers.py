...
__all__ = ['HungarianMatcher','HungarianMatcher_Rotate']
...
class HungarianMatcher_Rotate(nn.Layer):
    ...
    def forward(self,
        ...
        C = self.matcher_coeff['class'] * cost_class + \
            ...
            0.05 * cost_dfl
        # Hungarian matching requires finite entries. Keep occasional unstable
        # predictions from crashing the whole training step.
        C = paddle.nan_to_num(C, nan=1e6, posinf=1e6, neginf=-1e6)
